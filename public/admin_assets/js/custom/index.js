$(function () {
    ...
    $(document).on('submit', '.modal-body form', function (e) {
        ...
        $.ajax({
            url: url, data: data, method: "post", processData: false, contentType: false, success: function (response) {
                ...
                new Noty({
                    layout: 'topRight', type: 'alert', text: response, killer: true, timeout: 2000,
                }).show();
